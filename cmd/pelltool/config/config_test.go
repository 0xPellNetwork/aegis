...
func TestDefaultConfig(t *testing.T) {
	...
	require.Equal(t, cfg.PellURL, PellURL)
	require.Equal(t, cfg.BtcExplorerURL, BtcExplorerURL)
	require.Equal(t, cfg.StrategyManagerAddress, StrategyManagerAddress)
	require.Equal(t, cfg.DelegationManagerAddress, DelegationManagerAddress)
}
