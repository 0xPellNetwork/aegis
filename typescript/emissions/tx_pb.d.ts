...
// @generated from file emissions/tx.proto (package pellchain.pellcore.emissions, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message pellchain.pellcore.emissions.MsgWithdrawEmission
 */
export declare class MsgWithdrawEmission extends Message<MsgWithdrawEmission> {
  ...
  static readonly typeName = "pellchain.pellcore.emissions.MsgWithdrawEmission";
 ...
 *
 * @generated from message pellchain.pellcore.emissions.MsgWithdrawEmissionResponse
 */
export declare class MsgWithdrawEmissionResponse extends Message<MsgWithdrawEmissionResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "pellchain.pellcore.emissions.MsgWithdrawEmissionResponse";
  static readonly fields: FieldList;
