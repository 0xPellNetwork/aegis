...
// @generated from file relayer/tss_funds_migrator.proto (package pellchain.pellcore.relayer, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message pellchain.pellcore.relayer.TssFundMigratorInfo
 */
export declare class TssFundMigratorInfo extends Message<TssFundMigratorInfo> {
  ...
  /**
   * @generated from field: string migration_xmsg_index = 2;
   */
  migrationXmsgIndex: string;

  constructor(data?: PartialMessage<TssFundMigratorInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "pellchain.pellcore.relayer.TssFundMigratorInfo";
