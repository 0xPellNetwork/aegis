...
// @generated from file relayer/blame.proto (package pellchain.pellcore.relayer, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * node infomation
 *
 * @generated from message pellchain.pellcore.relayer.Node
 */
export declare class Node extends Message<Node> {
  ...
  static readonly typeName = "pellchain.pellcore.relayer.Node";
 ...
 * blame infomation
 *
 * @generated from message pellchain.pellcore.relayer.Blame
 */
export declare class Blame extends Message<Blame> {
  ...
  /**
   * @generated from field: repeated pellchain.pellcore.relayer.Node nodes = 3;
   */
  nodes: Node[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "pellchain.pellcore.relayer.Blame";
  static readonly fields: FieldList;
