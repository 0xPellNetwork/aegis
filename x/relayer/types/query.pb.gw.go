...
var (
	filter_Query_GetChainParams_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Query_GetChainParams_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_GetChainParams_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func request_Query_GetTssAddressByFinalizedHeight_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["finalized_pell_height"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "finalized_pell_height")
	}

	protoReq.FinalizedPellHeight, err = runtime.Int64(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "finalized_pell_height", err)
	}
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_HasVoted_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"pell-chain", "relayer", "has_voted", "ballot_identifier", "voter_address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BallotByIdentifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "ballot_by_identifier", "ballot_identifier"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ObserverSet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "observer_set"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SupportedChains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "supportedChains"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetChainParamsForChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "get_chain_params_for_chain", "chain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetChainParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "get_chain_params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NodeAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "nodeAccount", "index"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NodeAccountAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "nodeAccount"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CrosschainFlags_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "crosschain_flags"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Keygen_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "keygen"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ShowObserverCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"pell-chain", "relayer", "observer", "show_observer_count"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BlameByIdentifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "blame_by_identifier", "blame_identifier"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetAllBlameRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "get_all_blame_records"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BlamesByChainAndNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"pell-chain", "relayer", "blame_by_chain_and_nonce", "chain_id", "nonce"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetTssAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "get_tss_address", "bitcoin_chain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetTssAddressByFinalizedHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"pell-chain", "relayer", "get_tss_address_historical", "finalized_pell_height", "bitcoin_chain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TSS_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "TSS"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TssHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "tssHistory"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PendingNoncesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "pendingNonces"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PendingNoncesByChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "pendingNonces", "chain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ChainNonces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "relayer", "chainNonces", "index"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ChainNoncesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "relayer", "chainNonces"}, "", runtime.AssumeColonVerbOpt(true)))
)
