...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "emissions", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ListPoolAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "emissions", "list_addresses"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetEmissionsFactors_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "emissions", "get_emissions_factors"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ShowAvailableEmissions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"pell-chain", "emissions", "show_available_emissions", "address"}, "", runtime.AssumeColonVerbOpt(true)))
)
