...
func TestNewParams(t *testing.T) {
	...
	require.Equal(t, "00.15", params.ObserverEmissionPercentage, "ObserverEmissionPercentage should be set to 00.15")
	require.Equal(t, "00.25", params.TssSignerEmissionPercentage, "TssSignerEmissionPercentage should be set to 00.25")
	require.Equal(t, "00.10", params.TssGasEmissionPercentage, "TssSignerEmissionPercentage should be set to 00.10")
	...
	require.Equal(t, sdkmath.Int{}, params.ObserverSlashAmount, "ObserverSlashAmount should be initialized but is currently disabled")
}
...
func TestParamSetPairs(t *testing.T) {
	...
	require.Equal(t, 9, len(pairs), "The number of param set pairs should match the expected count")
	...
	assertParamSetPair(t, pairs, KeyPrefix(ParamObserverEmissionPercentage), "00.15", validateObserverEmissionPercentage)
	assertParamSetPair(t, pairs, KeyPrefix(ParamTssSignerEmissionPercentage), "00.25", validateTssEmissionPercentage)
	assertParamSetPair(t, pairs, KeyPrefix(ParamTssGasEmissionPercentage), "00.10", validateTssGasEmissionPercentage)
