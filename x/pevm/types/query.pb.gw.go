...
var (
	pattern_Query_SystemContract_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"pell-chain", "pevm", "system_contract"}, "", runtime.AssumeColonVerbOpt(true)))
)
