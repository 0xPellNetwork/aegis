...
func (k Keeper) ChainStateAll(c context.Context, req *types.QueryAllChainStateRequest) (*types.QueryChainStateAllResponse, error) {
	if req == nil {
	...
	return &types.QueryChainStateAllResponse{ChainState: chainStates, Pagination: pageRes}, nil
}

// ChainState queries chain state by chain
func (k Keeper) ChainState(c context.Context, req *types.QueryGetChainStateRequest) (*types.QueryChainStateResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	...
	return &types.QueryChainStateResponse{ChainState: &state}, nil
}
