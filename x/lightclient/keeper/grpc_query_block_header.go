...
func (k Keeper) BlockHeaderAll(c context.Context, req *types.QueryAllBlockHeaderRequest) (*types.QueryBlockHeaderAllResponse, error) {
	if req == nil {
	...
	return &types.QueryBlockHeaderAllResponse{BlockHeaders: blockHeaders, Pagination: pageRes}, nil
}

// BlockHeader queries block header by hash
func (k Keeper) BlockHeader(c context.Context, req *types.QueryGetBlockHeaderRequest) (*types.QueryBlockHeaderResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	...
	return &types.QueryBlockHeaderResponse{BlockHeader: &header}, nil
}
