...
// PevmAccountKeeper is an autogenerated mock type for the PevmAccountKeeper type
type PevmAccountKeeper struct {
	mock.Mock
}

// GetAccount provides a mock function with given fields: ctx, addr
func (_m *PevmAccountKeeper) GetAccount(ctx context.Context, addr types.AccAddress) types.AccountI {
...
func (_m *PevmAccountKeeper) GetModuleAccount(ctx context.Context, name string) types.ModuleAccountI {
...
func (_m *PevmAccountKeeper) GetSequence(ctx context.Context, addr types.AccAddress) (uint64, error) {
	ret := _m.Called(ctx, addr)
...
func (_m *PevmAccountKeeper) HasAccount(ctx context.Context, addr types.AccAddress) bool {
	ret := _m.Called(ctx, addr)
...
func (_m *PevmAccountKeeper) NewAccountWithAddress(ctx context.Context, addr types.AccAddress) types.AccountI {
	ret := _m.Called(ctx, addr)
...
func (_m *PevmAccountKeeper) SetAccount(ctx context.Context, acc types.AccountI) {
	_m.Called(ctx, acc)
}

// NewPevmAccountKeeper creates a new instance of PevmAccountKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPevmAccountKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *PevmAccountKeeper {
	mock := &PevmAccountKeeper{}
	mock.Mock.Test(t)
