...
// PevmEVMKeeper is an autogenerated mock type for the PevmEVMKeeper type
type PevmEVMKeeper struct {
	mock.Mock
}

// ApplyMessage provides a mock function with given fields: ctx, msg, tracer, commit
func (_m *PevmEVMKeeper) ApplyMessage(ctx types.Context, msg core.Message, tracer vm.EVMLogger, commit bool) (*evmtypes.MsgEthereumTxResponse, error) {
...
func (_m *PevmEVMKeeper) ChainID() *big.Int {
	ret := _m.Called()
...
func (_m *PevmEVMKeeper) EstimateGas(c context.Context, req *evmtypes.EthCallRequest) (*evmtypes.EstimateGasResponse, error) {
	ret := _m.Called(c, req)
...
func (_m *PevmEVMKeeper) GetAccount(ctx types.Context, addr common.Address) *statedb.Account {
...
func (_m *PevmEVMKeeper) GetBlockBloomTransient(ctx types.Context) *big.Int {
	ret := _m.Called(ctx)
...
func (_m *PevmEVMKeeper) GetCode(ctx types.Context, codeHash common.Hash) []byte {
...
func (_m *PevmEVMKeeper) GetLogSizeTransient(ctx types.Context) uint64 {
	ret := _m.Called(ctx)
...
func (_m *PevmEVMKeeper) SetAccount(ctx types.Context, addr common.Address, account statedb.Account) error {
...
func (_m *PevmEVMKeeper) SetBlockBloomTransient(ctx types.Context, bloom *big.Int) {
	_m.Called(ctx, bloom)
}

// SetLogSizeTransient provides a mock function with given fields: ctx, logSize
func (_m *PevmEVMKeeper) SetLogSizeTransient(ctx types.Context, logSize uint64) {
	_m.Called(ctx, logSize)
}

// WithChainID provides a mock function with given fields: ctx
func (_m *PevmEVMKeeper) WithChainID(ctx types.Context) {
	_m.Called(ctx)
}

// NewPevmEVMKeeper creates a new instance of PevmEVMKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPevmEVMKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *PevmEVMKeeper {
	mock := &PevmEVMKeeper{}
