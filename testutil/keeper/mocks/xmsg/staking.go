...
type XmsgStakingKeeper struct {
	mock.Mock
}

// GetAllValidators provides a mock function with given fields: ctx
func (_m *XmsgStakingKeeper) GetAllValidators(ctx context.Context) ([]types.Validator, error) {
	ret := _m.Called(ctx)
...
// NewXmsgStakingKeeper creates a new instance of XmsgStakingKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewXmsgStakingKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *XmsgStakingKeeper {
	mock := &XmsgStakingKeeper{}
	mock.Mock.Test(t)
