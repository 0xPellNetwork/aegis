...
type XmsgAuthorityKeeper struct {
	mock.Mock
}
...
// NewXmsgAuthorityKeeper creates a new instance of XmsgAuthorityKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewXmsgAuthorityKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *XmsgAuthorityKeeper {
	mock := &XmsgAuthorityKeeper{}
	mock.Mock.Test(t)
