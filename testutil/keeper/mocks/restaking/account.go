...
// RestakingAccountKeeper is an autogenerated mock type for the RestakingAccountKeeper type
type RestakingAccountKeeper struct {
	mock.Mock
}

// GetAccount provides a mock function with given fields: ctx, addr
func (_m *RestakingAccountKeeper) GetAccount(ctx context.Context, addr types.AccAddress) types.AccountI {
...
func (_m *RestakingAccountKeeper) GetModuleAccount(ctx context.Context, name string) types.ModuleAccountI {
...
func (_m *RestakingAccountKeeper) GetSequence(ctx context.Context, addr types.AccAddress) (uint64, error) {
	ret := _m.Called(ctx, addr)
...
func (_m *RestakingAccountKeeper) HasAccount(ctx context.Context, addr types.AccAddress) bool {
	ret := _m.Called(ctx, addr)
...
func (_m *RestakingAccountKeeper) NewAccountWithAddress(ctx context.Context, addr types.AccAddress) types.AccountI {
	ret := _m.Called(ctx, addr)
...
func (_m *RestakingAccountKeeper) SetAccount(ctx context.Context, acc types.AccountI) {
	_m.Called(ctx, acc)
}

// NewRestakingAccountKeeper creates a new instance of RestakingAccountKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRestakingAccountKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *RestakingAccountKeeper {
	mock := &RestakingAccountKeeper{}
	mock.Mock.Test(t)
