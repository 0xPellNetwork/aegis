...
// RelayerLightclientKeeper is an autogenerated mock type for the RelayerLightclientKeeper type
type RelayerLightclientKeeper struct {
	mock.Mock
}

// AddBlockHeader provides a mock function with given fields: ctx, chainID, height, blockHash, header, parentHash
func (_m *RelayerLightclientKeeper) AddBlockHeader(ctx types.Context, chainID int64, height int64, blockHash []byte, header proofs.HeaderData, parentHash []byte) {
...
func (_m *RelayerLightclientKeeper) CheckNewBlockHeader(ctx types.Context, chainID int64, blockHash []byte, height int64, header proofs.HeaderData) ([]byte, error) {
...
// NewRelayerLightclientKeeper creates a new instance of RelayerLightclientKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRelayerLightclientKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *RelayerLightclientKeeper {
	mock := &RelayerLightclientKeeper{}
	mock.Mock.Test(t)
