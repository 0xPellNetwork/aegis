...
// NewXSecurityLightclientKeeper creates a new instance of XSecurityLightclientKeeper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewXSecurityLightclientKeeper(t interface {
	mock.TestingT
	Cleanup(func())
}) *XSecurityLightclientKeeper {
	mock := &XSecurityLightclientKeeper{}
	mock.Mock.Test(t)
