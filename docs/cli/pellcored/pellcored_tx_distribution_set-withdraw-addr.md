...
Example:
$ pellcored tx distribution set-withdraw-addr pell1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p --from mykey

```
pellcored tx distribution set-withdraw-addr [withdraw-addr] [flags]
```
