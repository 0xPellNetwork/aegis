...
Example:
$ pellcored query tx [hash]
$ pellcored query tx --type=acc_seq [addr]/[sequence]
$ pellcored query tx --type=signature [sig1_base64],[sig2_base64...]

```
pellcored query tx --type=[hash|acc_seq|signature] [hash|acc_seq|signature] [flags]
```
