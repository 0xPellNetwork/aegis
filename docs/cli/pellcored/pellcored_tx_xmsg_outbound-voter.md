# tx xmsg outbound-voter

Broadcast message receiveConfirmation

```
pellcored tx xmsg outbound-voter [sendHash] [outTxHash] [outBlockHeight] [outGasUsed] [outEffectiveGasPrice] [outEffectiveGasLimit] [Status] [chain] [outTXNonce]  [flags]
```
