...
Example:
$ pellcored tx gov submit-proposal community-pool-spend [path/to/proposal.json] --from=[key_or_address]
...

{
  ...
  "recipient": "pell1s5afhd6gxevu37mkqcvvsj8qeylhn0rz46zdlq",
  "amount": "1000stake",
  "deposit": "1000stake"
}

```
pellcored tx gov submit-legacy-proposal community-pool-spend [proposal-file] [flags]
```
