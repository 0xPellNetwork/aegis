...
```
pellcored tx group update-group-members [admin] [group-id] [members-json-file] [flags]
```
...
pellcored tx group update-group-members [admin] [group-id] [members-json-file]
