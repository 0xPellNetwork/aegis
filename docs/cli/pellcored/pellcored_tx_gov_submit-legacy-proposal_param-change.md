...
Example:
$ pellcored tx gov submit-proposal param-change [path/to/proposal.json] --from=[key_or_address]
...
```
pellcored tx gov submit-legacy-proposal param-change [proposal-file] [flags]
```
