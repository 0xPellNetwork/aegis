...
find the proposal-id by running "pellcored query gov proposals".

Example:
$ pellcored tx gov weighted-vote 1 yes=0.6,no=0.3,abstain=0.05,no_with_veto=0.05 --from mykey

```
pellcored tx gov weighted-vote [proposal-id] [weighted-options] [flags]
```
