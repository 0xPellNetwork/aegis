...
```
pellcored tx group create-group-policy [admin] [group-id] [metadata] [decision-policy-json-file] [flags]
```
...
pellcored tx group create-group-policy [admin] [group-id] [metadata] policy.json
