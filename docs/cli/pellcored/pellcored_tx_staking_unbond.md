...
Example:
$ pellcored tx staking unbond pellvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100stake --from mykey

```
pellcored tx staking unbond [validator-addr] [amount] [flags]
```
