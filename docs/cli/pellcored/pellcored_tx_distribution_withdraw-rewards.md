...
Example:
$ pellcored tx distribution withdraw-rewards pellvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey
$ pellcored tx distribution withdraw-rewards pellvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey --commission

```
pellcored tx distribution withdraw-rewards [validator-addr] [flags]
```
